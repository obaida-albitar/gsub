...
from gsub.shortcuts import SECTION_ORDER, entries_for_section
from gsub.utils import merge_font_families, is_font_installed
from gsub.widgets.style_props_editor import (
...
# The shortcut list itself lives in gsub.shortcuts (the single
...
def build_shortcuts_dialog() -> Adw.ShortcutsDialog:
    ...
    gsub.shortcuts, so the dialog always matches the accels
